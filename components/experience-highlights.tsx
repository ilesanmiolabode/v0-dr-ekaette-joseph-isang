    ...
    <section className="py-24 lg:py-40 bg-background relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-6 mb-20 animate-fade-in-up">
          <h2 className="text-5xl lg:text-6xl font-bold text-foreground tracking-tight">Healthcare Leadership</h2>
                ...
                <CardHeader className="pb-8">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div className="space-y-3">
                      <CardTitle className="text-3xl font-bold text-primary group-hover:text-accent transition-colors">
                        {exp.title}
                      </CardTitle>
                  ...
                  <CardDescription className="text-xl leading-relaxed lg:leading-8 mt-6">{exp.description}</CardDescription>
                </CardHeader>
                <CardContent>
